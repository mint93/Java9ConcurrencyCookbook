package chapter08_customizingConcurrencyClasses.recipe09_transferPriorityQueue.task;
...
public class MyPriorityTransferQueue<E> extends PriorityBlockingQueue<E> implements TransferQueue<E> {
	...
	/**
	 * Lock to control the access to the operations
	 */
	...
	/**
	 * This method tries to transfer an element directly to a consumer. If there
	 * is a consumer waiting, we puts the element in the queue and return the
	...
	public void transfer(E e) throws InterruptedException {
		...
		if (counter.get() != 0) {
			...
			// Current thread must own the object’s monitor. This can happen when:
	 ...
	 * queue is empty. If there are transfered elements, takes the first
