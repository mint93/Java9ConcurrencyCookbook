package chapter08_customizingConcurrencyClasses.recipe05_customizeScheduledThreadPool.main;

import java.util.Date;
import java.util.concurrent.TimeUnit;

import chapter08_customizingConcurrencyClasses.recipe05_customizeScheduledThreadPool.task.MyScheduledThreadPoolExecutor;
import chapter08_customizingConcurrencyClasses.recipe05_customizeScheduledThreadPool.task.Task;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * Send to the executor a delayed task. It will begin its execution after 1 second of delay
