package chapter04_threadExecutors.recipe03_invokeAny.main;
...
import chapter04_threadExecutors.recipe03_invokeAny.task.UserValidator;
import chapter04_threadExecutors.recipe03_invokeAny.task.ValidatorTask;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// that finished without throw and Exception. If all the tasks throw and Exception, the
