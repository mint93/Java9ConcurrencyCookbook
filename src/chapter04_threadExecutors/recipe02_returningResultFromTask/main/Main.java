package chapter04_threadExecutors.recipe02_returningResultFromTask.main;
...
import chapter04_threadExecutors.recipe02_returningResultFromTask.task.FactorialCalculator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Create and send to the executor 10 tasks
		for (int i=0; i<10; i++){
