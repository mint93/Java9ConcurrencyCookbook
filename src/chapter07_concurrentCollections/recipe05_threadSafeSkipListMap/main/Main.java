package chapter07_concurrentCollections.recipe05_threadSafeSkipListMap.main;

import java.util.Map;
import java.util.concurrent.ConcurrentNavigableMap;
import java.util.concurrent.ConcurrentSkipListMap;

import chapter07_concurrentCollections.recipe05_threadSafeSkipListMap.task.Task;
import chapter07_concurrentCollections.recipe05_threadSafeSkipListMap.util.Contact;
