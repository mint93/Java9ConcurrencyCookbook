package chapter07_concurrentCollections.recipe02_blockingThreadSafeDeque.main;

import java.util.Date;
import java.util.concurrent.LinkedBlockingDeque;
import java.util.concurrent.TimeUnit;

import chapter07_concurrentCollections.recipe02_blockingThreadSafeDeque.task.Client;
