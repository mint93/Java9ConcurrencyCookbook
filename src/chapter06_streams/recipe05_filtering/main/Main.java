package chapter06_streams.recipe05_filtering.main;

import java.util.Arrays;
import java.util.List;

import chapter06_streams.recipe05_filtering.util.Person;
import chapter06_streams.recipe05_filtering.util.PersonGenerator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// distinct() operation is a stateful operation, so it won't get
		// a good performance with parallel	streams (as the Java
		// documentation reflects, '... under parallel computation, some
		// pipelines containing stateful intermediate operations 
		// may require multiple passes on the data or may need to
		// buffer significant data...').
