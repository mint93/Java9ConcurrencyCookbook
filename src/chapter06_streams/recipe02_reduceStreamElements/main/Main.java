package chapter06_streams.recipe02_reduceStreamElements.main;

import java.util.List;
import java.util.Optional;
import java.util.stream.DoubleStream;

import chapter06_streams.recipe02_reduceStreamElements.util.DoubleGenerator;
import chapter06_streams.recipe02_reduceStreamElements.util.Person;
import chapter06_streams.recipe02_reduceStreamElements.util.PersonGenerator;
import chapter06_streams.recipe02_reduceStreamElements.util.Point;
import chapter06_streams.recipe02_reduceStreamElements.util.PointGenerator;
...
public class Main {
	...
	public static void main(String args[]) {
		...
		Integer value=0;
		// Identity – an element that is the initial value of the
		// reduction operation and the default result if the stream is empty
		...
		// reduction operation when the reduction is parallelized,
		// or when there’s a mismatch between the types of the accumulator
		// arguments and the types of the accumulator implementation
		
		// When a stream executes in parallel, the Java runtime splits
		// the stream into multiple substreams. In such cases, we need
		// to use a function to combine the results of the substreams
		// into a single one. This is the role of the combiner
