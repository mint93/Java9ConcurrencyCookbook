package chapter05_forkJoinFramework.recipe01_createForkJoinPool.main;

import java.util.List;
import java.util.concurrent.ForkJoinPool;
import java.util.concurrent.TimeUnit;

import chapter05_forkJoinFramework.recipe01_createForkJoinPool.task.Task;
import chapter05_forkJoinFramework.recipe01_createForkJoinPool.util.Product;
import chapter05_forkJoinFramework.recipe01_createForkJoinPool.util.ProductListGenerator;
