package chapter03_synchronizationUtilities.recipe06_exchanger.task;
...
public class Consumer implements Runnable {
	...
	/**
	 * Main method of the consumer. It consumes all the events produced by the Producer. After
