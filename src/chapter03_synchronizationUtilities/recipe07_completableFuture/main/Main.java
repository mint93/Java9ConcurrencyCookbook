package chapter03_synchronizationUtilities.recipe07_completableFuture.main;

import java.util.List;
import java.util.concurrent.CompletableFuture;
import java.util.concurrent.ExecutionException;

import chapter03_synchronizationUtilities.recipe07_completableFuture.task.NumberListGenerator;
import chapter03_synchronizationUtilities.recipe07_completableFuture.task.NumberSelector;
import chapter03_synchronizationUtilities.recipe07_completableFuture.task.SeedGenerator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		// After startFuture is complete, then start new task in new thread (async)
		...
		// After step2Future is complete, then start new task in the same thread
		...
		// After all tasks are complete, then start new task in new thread (async)
