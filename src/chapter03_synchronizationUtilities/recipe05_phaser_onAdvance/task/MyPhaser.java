package chapter03_synchronizationUtilities.recipe05_phaser_onAdvance.task;
...
public class MyPhaser extends Phaser {
	...
	/**
	 * This method is called when the last registered thread calls one of the advance methods
	 * in the actual phase. It is called before phase change and before waking up all the
	 * threads that were sleeping in the arriveAndAwaitAdvance() method
