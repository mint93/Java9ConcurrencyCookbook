package chapter01_threadManagement.recipe01_creatingAndRunningThread.main;
...
import chapter01_threadManagement.recipe01_creatingAndRunningThread.task.Calculator;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try (FileWriter file = new FileWriter("./src/chapter01_threadManagement/recipe01_creatingAndRunningThread/log.txt");
